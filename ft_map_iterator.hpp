...
/*   Updated: 2022/02/04 16:43:08 by pmontiel         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
namespace ft
{
    ...
    class map_iterator
    {
        ...
        public :
        map_iterator(t_iterator node1) : _p(node1){}
        map_iterator(const key_compare &comp = key_compare()) : _p(nullptr), _comp(comp) {}
        template<class Iter, class fill1, class fill2>
		map_iterator(const map_iterator<Iter, fill1, fill2>& iter) : _p(iter.base()) {};
	...
	bool operator==(const map_iterator<Node1, T1, Comp1> &rhs, const map_iterator<Node2, T2, Comp2> &lhs)
	{
